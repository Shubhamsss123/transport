...
function update()
{
	...
	var info = tab_user;
	info += separator;
	info += trim(document.getElementById('fname').value);	//remove leading and trailing spaces
	info += separator;
	info += trim(document.getElementById('lname').value);
	info += separator;
	info += trim(document.getElementById('designation').value);
	info += separator;
	info += trim(document.getElementById('org').value);
	info += separator;
	info += trim(document.getElementById('address1').value);
	info += separator;
	info += trim(document.getElementById('address2').value);
	info += separator;
	info += trim(document.getElementById('city').value);
	info += separator;
	info += trim(document.getElementById('zip').value);
	info += separator;
	info += trim(document.getElementById('country').value);
	info += separator;
	info += trim(document.getElementById('contact').value);
	...
	xmlhttp.open("POST","../php/update_user_info.php",true)
...
function validate()
{
	...
	if(trim(keywords) == "" || trim(keywords) == null)
	{
		alert("Keywords for the paper missing!");
		return false;
	}
	...
	author[0] = document.getElementById('author2').value;
	author[1] = document.getElementById('author3').value;
	author[2] = document.getElementById('author4').value;
	author[3] = document.getElementById('author5').value;
	author[4] = document.getElementById('author6').value;
	//check if email id valid for all authors
	if(!(check_id(author[0]))) {alert("Seems to be an invalid email-id!"); return false;}
	if(!(check_id(author[1]))) {alert("Seems to be an invalid email-id!"); return false;}
	if(!(check_id(author[2]))) {alert("Seems to be an invalid email-id!"); return false;}
	if(!(check_id(author[3]))) {alert("Seems to be an invalid email-id!"); return false;}
	if(!(check_id(author[4]))) {alert("Seems to be an invalid email-id!"); return false;}
...
function upload_paper()
{
	...
	if(document.getElementById && document.createElement)
	{
		...
		document.getElementById('line1').innerHTML = "Title of paper: <input type=\'text\' name= \'title\' id=\'title\'>";
		...
		document.getElementById('line2').innerHTML = "Keywords: <input type=\'text\' name= \'keywords\' id=\'keywords\'>";
		document.getElementById('keywords').style.width = "200px";
		...
		document.getElementById('line9').innerHTML = "Paper:<input type=\'hidden\' name= \'MAX_FILE_SIZE\' value=\'10000000\'> <input name=\'paper_file\' id='paper_file' title=\'Upload your abstract\' type=\'file\'>";
...
function hidePaperInfo(a)
{
	...
	if(a.name == "hidePaperInfo1")
	{
		...
		var top = document.getElementById('footer1').offsetTop;
		var increase = document.getElementById('line2').offsetHeight;
		top = top - increase + 50;
		document.getElementById('footer1').style.top = top+"px";
		document.getElementById('line2').innerHTML = "";
	}
		...
		if(xmlhttp.readyState==4 && xmlhttp.status==200)
		{
			...
			else
			{
				...
				if(a.name == "showPaper1")
				{
					...
					//document.getElementById('line2').innerHTML = "<span id='seePaperId1'></span><br><span id='seePaperTitle1'></span><br><span id='seePaperKeywords1'></span><br><span id='seePaperOtherAuthors11'></span><br><span id='seePaperOtherAuthors12'></span><br><span id='seePaperOtherAuthors13'></span><br><span id='seePaperOtherAuthors14'></span><br><span id='seePaperOtherAuthors15'></span><br><span id='seePaperDate1'></span><br>";
				...
				else if(a.name == "showPaper2")
				{
					...
					//document.getElementById('line4').innerHTML = "<span id='seePaperId2'></span><br><span id='seePaperTitle2'></span><br><span id='seePaperKeywords2'></span><br><span id='seePaperOtherAuthors21'></span><br><span id='seePaperOtherAuthors22'></span><br><span id='seePaperOtherAuthors23'></span><br><span id='seePaperOtherAuthors24'></span><br><span id='seePaperOtherAuthors25'></span><br><span id='seePaperDate2'></span><br>";
				...
				else if(a.name == "showPaper3")
				{
					...
					//document.getElementById('line6').innerHTML = "<span id='seePaperId3'></span><br><span id='seePaperTitle3'></span><br><span id='seePaperKeywords3'></span><br><span id='seePaperOtherAuthors31'></span><br><span id='seePaperOtherAuthors32'></span><br><span id='seePaperOtherAuthors33'></span><br><span id='seePaperOtherAuthors34'></span><br><span id='seePaperOtherAuthors35'></span><br><span id='seePaperDate3'></span><b>";
